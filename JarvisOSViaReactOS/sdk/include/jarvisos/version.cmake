...
if(EXISTS "${JARVISOS_SOURCE_DIR}/.git")
    find_package(Git)
    if(GIT_FOUND)
        execute_process(
            COMMAND "${GIT_EXECUTABLE}" rev-parse HEAD
            WORKING_DIRECTORY ${JARVISOS_SOURCE_DIR}
...
configure_file(sdk/include/jarvisos/version.h.cmake ${JARVISOS_BINARY_DIR}/sdk/include/jarvisos/version.h)
configure_file(sdk/include/jarvisos/buildno.h.cmake ${JARVISOS_BINARY_DIR}/sdk/include/jarvisos/buildno.h)

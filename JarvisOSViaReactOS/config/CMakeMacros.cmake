...
macro(set_cpp)
    ...
    if(__cppopts_WITH_STL)
        set(CPP_USE_STL 1)
        if(MSVC)
            add_definitions(-DNATIVE_CPP_INCLUDE=${JARVISOS_SOURCE_DIR}/sdk/include/c++)
            include_directories(${JARVISOS_SOURCE_DIR}/sdk/include/c++/stlport)
        else()
...
function(add_dependency_node _node)
    if(GENERATE_DEPENDENCY_GRAPH)
        ...
        if(_type MATCHES SHARED_LIBRARY|MODULE_LIBRARY OR ${_node} MATCHES ntoskrnl)
            file(APPEND ${JARVISOS_BINARY_DIR}/dependencies.graphml "    <node id=\"${_node}\"/>\n")
        endif()
     endif()
endfunction()
...
function(add_dependency_edge _source _target)
    if(GENERATE_DEPENDENCY_GRAPH)
        ...
        if(_type MATCHES SHARED_LIBRARY|MODULE_LIBRARY)
            file(APPEND ${JARVISOS_BINARY_DIR}/dependencies.graphml "    <edge source=\"${_source}\" target=\"${_target}\"/>\n")
        endif()
    endif()
endfunction()

function(add_dependency_header)
    file(WRITE ${JARVISOS_BINARY_DIR}/dependencies.graphml "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<graphml>\n  <graph id=\"ReactOS dependencies\" edgedefault=\"directed\">\n")
endfunction()

function(add_dependency_footer)
    add_dependency_node(ntdll)
    file(APPEND ${JARVISOS_BINARY_DIR}/dependencies.graphml "  </graph>\n</graphml>\n")
endfunction()
...
# boot/bootdata/packages/jarvisos.dff.in
#
macro(dir_to_num dir var)
    if(${dir} STREQUAL jarvisos)
        set(${var} 1)
    elseif(${dir} STREQUAL jarvisos/system32)
        set(${var} 2)
    elseif(${dir} STREQUAL jarvisos/system32/drivers)
        set(${var} 3)
    elseif(${dir} STREQUAL jarvisos/Fonts)
        set(${var} 4)
    elseif(${dir} STREQUAL jarvisos/system32/drivers/etc)
        set(${var} 5)
    elseif(${dir} STREQUAL jarvisos/inf)
        set(${var} 6)
    elseif(${dir} STREQUAL jarvisos/bin)
        set(${var} 7)
    elseif(${dir} STREQUAL jarvisos/bin/testdata)
        set(${var} 8)
    elseif(${dir} STREQUAL jarvisos/bin/suppl)
        set(${var} 80)
    elseif(${dir} STREQUAL jarvisos/media)
        set(${var} 9)
    elseif(${dir} STREQUAL jarvisos/Microsoft.NET)
        set(${var} 10)
    elseif(${dir} STREQUAL jarvisos/Microsoft.NET/Framework)
        set(${var} 11)
    elseif(${dir} STREQUAL jarvisos/Microsoft.NET/Framework/v1.0.3705)
        set(${var} 12)
    elseif(${dir} STREQUAL jarvisos/Microsoft.NET/Framework/v1.1.4322)
        set(${var} 13)
    elseif(${dir} STREQUAL jarvisos/Microsoft.NET/Framework/v2.0.50727)
        set(${var} 14)
    elseif(${dir} STREQUAL jarvisos/Resources)
        set(${var} 15)
    elseif(${dir} STREQUAL jarvisos/Resources/Themes)
        set(${var} 16)
    elseif(${dir} STREQUAL jarvisos/system32/wbem)
        set(${var} 17)
    elseif(${dir} STREQUAL jarvisos/Resources/Themes/Lautus)
        set(${var} 18)
    elseif(${dir} STREQUAL jarvisos/Help)
        set(${var} 19)
    elseif(${dir} STREQUAL jarvisos/Config)
        set(${var} 20)
    elseif(${dir} STREQUAL jarvisos/Cursors)
        set(${var} 21)
    elseif(${dir} STREQUAL jarvisos/system32/ShellExt)
        set(${var} 22)
    elseif(${dir} STREQUAL jarvisos/Temp)
        set(${var} 23)
    elseif(${dir} STREQUAL jarvisos/system32/spool)
        set(${var} 24)
    elseif(${dir} STREQUAL jarvisos/system32/spool/drivers)
        set(${var} 25)
    elseif(${dir} STREQUAL jarvisos/system32/spool/drivers/color)
        set(${var} 26)
    elseif(${dir} STREQUAL jarvisos/system32/spool/drivers/w32x86)
        set(${var} 27)
    elseif(${dir} STREQUAL jarvisos/system32/spool/drivers/w32x86/3)
        set(${var} 28)
    elseif(${dir} STREQUAL jarvisos/system32/spool/prtprocs)
        set(${var} 29)
    elseif(${dir} STREQUAL jarvisos/system32/spool/prtprocs/w32x86)
        set(${var} 30)
    elseif(${dir} STREQUAL jarvisos/system32/spool/PRINTERS)
        set(${var} 31)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/Repository)
        set(${var} 32)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/Repository/FS)
        set(${var} 33)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/mof/good)
        set(${var} 34)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/mof/bad)
        set(${var} 35)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/AdStatus)
        set(${var} 36)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/xml)
        set(${var} 37)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/Logs)
        set(${var} 38)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/AutoRecover)
        set(${var} 39)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/snmp)
        set(${var} 40)
    elseif(${dir} STREQUAL jarvisos/system32/wbem/Performance)
        set(${var} 41)
    elseif(${dir} STREQUAL jarvisos/twain_32)
        set(${var} 42)
    elseif(${dir} STREQUAL jarvisos/repair)
        set(${var} 43)
    elseif(${dir} STREQUAL jarvisos/Web)
        set(${var} 44)
    elseif(${dir} STREQUAL jarvisos/Web/Wallpaper)
        set(${var} 45)
    elseif(${dir} STREQUAL jarvisos/Prefetch)
        set(${var} 46)
    elseif(${dir} STREQUAL jarvisos/security)
        set(${var} 47)
    elseif(${dir} STREQUAL jarvisos/security/Database)
        set(${var} 48)
    elseif(${dir} STREQUAL jarvisos/security/logs)
        set(${var} 49)
    elseif(${dir} STREQUAL jarvisos/security/templates)
        set(${var} 50)
    elseif(${dir} STREQUAL jarvisos/system32/CatRoot)
        set(${var} 51)
    elseif(${dir} STREQUAL jarvisos/system32/CatRoot2)
        set(${var} 52)
    elseif(${dir} STREQUAL jarvisos/AppPatch)
        set(${var} 53)
    elseif(${dir} STREQUAL jarvisos/winsxs)
        set(${var} 54)
    elseif(${dir} STREQUAL jarvisos/winsxs/manifests)
        set(${var} 55)
    elseif(${dir} STREQUAL jarvisos/winsxs/x86_microsoft.windows.common-controls_6595b64144ccf1df_5.82.2600.2982_none_deadbeef)
        set(${var} 56)
    elseif(${dir} STREQUAL jarvisos/winsxs/x86_microsoft.windows.common-controls_6595b64144ccf1df_6.0.2600.2982_none_deadbeef)
        set(${var} 57)
    elseif(${dir} STREQUAL jarvisos/winsxs/x86_microsoft.windows.gdiplus_6595b64144ccf1df_1.1.7601.23038_none_deadbeef)
        set(${var} 58)
    elseif(${dir} STREQUAL jarvisos/winsxs/x86_reactos.apisets_6595b64144ccf1df_1.0.0.0_none_deadbeef)
        set(${var} 59)
    elseif(${dir} STREQUAL jarvisos/winsxs/x86_reactos.newapi_6595b64144ccf1df_1.0.0.0_none_deadbeef)
        set(${var} 60)
    elseif(${dir} STREQUAL jarvisos/winsxs/x86_microsoft.windows.gdiplus_6595b64144ccf1df_1.0.14393.0_none_deadbeef)
        set(${var} 61)
    elseif(${dir} STREQUAL jarvisos/Resources/Themes/Modern)
        set(${var} 62)
    elseif(${dir} STREQUAL jarvisos/3rdParty)
        set(${var} 63)
    elseif(${dir} STREQUAL jarvisos/Resources/Themes/Lunar)
        set(${var} 64)	
    elseif(${dir} STREQUAL jarvisos/Resources/Themes/Mizu)
        set(${var} 65)
    elseif(${dir} STREQUAL jarvisos/system32/spool/prtprocs/x64)
        set(${var} 66)
    else()
...
function(add_cd_file)
    ...
    if(NOT __cd EQUAL -1)
        # whether or not we should put it in jarvisos.cab or directly on cd
        if(_CD_NO_CAB)
            # directly on cd
            ...
            # add it in jarvisos.cab
            dir_to_num(${_CD_DESTINATION} _num)
            file(APPEND ${JARVISOS_BINARY_DIR}/boot/bootdata/packages/jarvisos.dff.cmake "\"${_CD_FILE}\" ${_num}\n")
            # manage dependency - target level
            if(_CD_TARGET)
                add_dependencies(jarvisos_cab_inf ${_CD_TARGET})
            endif()
    ...
    if(NOT __cd EQUAL -1)
        ...
        if(_CD_NO_CAB)
            ...
            #add it in jarvisos.cab
            #dir_to_num(${_CD_DESTINATION} _num)
            #file(APPEND ${JARVISOS_BINARY_DIR}/boot/bootdata/packages/jarvisos.dff.dyn "${_CD_FILE} ${_num}\n")
            #if(_CD_TARGET)
            #    #manage dependency
...
function(create_iso_lists)
    # generate jarvisos.cab before anything else
    get_property(_filelist GLOBAL PROPERTY REACTOS_CAB_DEPENDS)

    # begin with jarvisos.inf. We want this command to be always executed, so we pretend it generates another file although it will never do.
    add_custom_command(
        OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/jarvisos.inf ${CMAKE_CURRENT_BINARY_DIR}/__some_non_existent_file
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ${JARVISOS_BINARY_DIR}/boot/bootdata/packages/jarvisos.inf ${CMAKE_CURRENT_BINARY_DIR}/jarvisos.inf
        DEPENDS ${JARVISOS_BINARY_DIR}/boot/bootdata/packages/jarvisos.inf jarvisos_cab_inf)

    add_custom_command(
        OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/jarvisos.cab
        COMMAND native-cabman -C ${JARVISOS_BINARY_DIR}/boot/bootdata/packages/jarvisos.dff -RC ${CMAKE_CURRENT_BINARY_DIR}/jarvisos.inf -N -P ${JARVISOS_SOURCE_DIR}
        DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/jarvisos.inf native-cabman ${_filelist})

    add_custom_target(reactos_cab DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/jarvisos.cab)
    add_dependencies(reactos_cab jarvisos_cab_inf)

    add_cd_file(
        TARGET reactos_cab
        FILE ${CMAKE_CURRENT_BINARY_DIR}/jarvisos.cab
    ...
    string(REPLACE ";" "\n" _filelist "${_filelist}")
    file(APPEND ${JARVISOS_BINARY_DIR}/boot/bootcd.cmake.lst "${_filelist}")
    unset(_filelist)
    file(GENERATE
         OUTPUT ${JARVISOS_BINARY_DIR}/boot/bootcd.$<CONFIG>.lst
         INPUT ${JARVISOS_BINARY_DIR}/boot/bootcd.cmake.lst)

    get_property(_filelist GLOBAL PROPERTY LIVECD_FILE_LIST)
    string(REPLACE ";" "\n" _filelist "${_filelist}")
    file(APPEND ${JARVISOS_BINARY_DIR}/boot/livecd.cmake.lst "${_filelist}")
    unset(_filelist)
    file(GENERATE
         OUTPUT ${JARVISOS_BINARY_DIR}/boot/livecd.$<CONFIG>.lst
         INPUT ${JARVISOS_BINARY_DIR}/boot/livecd.cmake.lst)

    get_property(_filelist GLOBAL PROPERTY HYBRIDCD_FILE_LIST)
    string(REPLACE ";" "\n" _filelist "${_filelist}")
    file(APPEND ${JARVISOS_BINARY_DIR}/boot/hybridcd.cmake.lst "${_filelist}")
    unset(_filelist)
    file(GENERATE
         OUTPUT ${JARVISOS_BINARY_DIR}/boot/hybridcd.$<CONFIG>.lst
         INPUT ${JARVISOS_BINARY_DIR}/boot/hybridcd.cmake.lst)

    get_property(_filelist GLOBAL PROPERTY BOOTCDREGTEST_FILE_LIST)
    string(REPLACE ";" "\n" _filelist "${_filelist}")
    file(APPEND ${JARVISOS_BINARY_DIR}/boot/bootcdregtest.cmake.lst "${_filelist}")
    unset(_filelist)
    file(GENERATE
         OUTPUT ${JARVISOS_BINARY_DIR}/boot/bootcdregtest.$<CONFIG>.lst
         INPUT ${JARVISOS_BINARY_DIR}/boot/bootcdregtest.cmake.lst)
endfunction()
...
function(add_clean_target _target)
    ...
    elseif(CMAKE_GENERATOR STREQUAL "Ninja")
        ...
        set(_clean_working_directory ${JARVISOS_BINARY_DIR})
    endif()
...
function(create_registry_hives)
    ...
    add_cd_file(
        FILE ${CMAKE_BINARY_DIR}/boot/bootdata/system
             ...
             ${CMAKE_BINARY_DIR}/boot/bootdata/security
        TARGET livecd_hives
        DESTINATION jarvisos/system32/config
        FOR livecd)
...
function(add_rostests_file)
    ...
    if(_ROSTESTS_TARGET)
        add_cd_file(TARGET ${_ROSTESTS_TARGET} FILE ${_ROSTESTS_FILE} DESTINATION "jarvisos/bin${_ROSTESTS_SUBDIR}" NAME_ON_CD ${_ROSTESTS_NAME_ON_CD} FOR all)
    else()
        add_cd_file(FILE ${_ROSTESTS_FILE} DESTINATION "jarvisos/bin${_ROSTESTS_SUBDIR}" NAME_ON_CD ${_ROSTESTS_NAME_ON_CD} FOR all)
    endif()

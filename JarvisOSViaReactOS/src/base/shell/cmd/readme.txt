...
Compiling
~~~~~~~~~
ROS cmd used to depend on __LCARSOS__ to provide two different ways to build cmd.  There is still code left in it for this but...  The __LCARSOS__ = 0 has not been develped, maintained.  And therefore it does not even compile anymore.  __LCARSOS__ = 1 works fine on both windows(nt). and someday i plan to remove all the __LCARSOS__ = 0.

 ...
 * PROJECT:         JarvisOS Setup Library
...
/*
 * This code enumerates the list of files in jarvisos.dff / jarvisos.inf
 * that need to be extracted from jarvisos.cab and be installed in their
    ...
    IN PFILE_COPY_STATUS_ROUTINE StatusRoutine OPTIONAL)
{
    ...
    PCWSTR CabinetName;
    UINT ErrorLine;
#if defined(__LCARSOS__) && defined(USE_CABINET_INF)
    ULONG InfFileSize;
    PVOID InfFileData;

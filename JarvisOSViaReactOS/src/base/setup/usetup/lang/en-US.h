...
{
    {
        4,
        3,
        " JarvisOS " KERNEL_VERSION_STR " Setup ",
    ...
    },
    {
        0,
        20,
        "Please wait while the JarvisOS Setup initializes itself",
...
static MUI_ENTRY enUSWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "This part of the setup copies the JarvisOS Operating System to your",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Press ENTER to install or upgrade JarvisOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
     // "\x07  Press R to repair a JarvisOS installation using the Recovery Console.",
        "\x07  Press R to repair a JarvisOS installation.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Press L to view the JarvisOS Licensing Terms and Conditions.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Press F3 to quit without installing JarvisOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "For more information on JarvisOS, please visit:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "JarvisOS is in Alpha stage, meaning it is not feature-complete",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "to run JarvisOS on real hardware.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Press ENTER to continue JarvisOS Setup.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "The JarvisOS System is licensed under the terms of the",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "All software that is part of the JarvisOS system is",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "JarvisOS only covers distribution to third parties.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public License with JarvisOS please visit",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "JarvisOS Setup is in an early development phase. It does not yet",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "The JarvisOS Setup can upgrade one of the available JarvisOS installations",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "listed below, or, if a JarvisOS installation is damaged, the Setup program",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "JarvisOS is not completely installed.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "The basic components of JarvisOS have been installed successfully.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Press ENTER to install JarvisOS onto the selected partition.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "uses a format not supported by JarvisOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "In order to successfully install JarvisOS, the Setup program must change",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "to the original one after finishing the installation of JarvisOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        11,
        "programs, programs to start an operating system (like JarvisOS) or other",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "computer from the harddisk until you finished the JarvisOS Setup.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup installs JarvisOS files onto the selected partition. Choose a",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "directory where you want JarvisOS to be installed:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "characters and then type the directory where you want JarvisOS to",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Please wait while JarvisOS Setup copies files to your JarvisOS",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup prepares your computer for copying the JarvisOS files.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR enUSErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "JarvisOS is not completely installed on your\n"
        "computer. If you quit Setup now, you will need to\n"
        "run Setup again to install JarvisOS.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Failed to build the installation paths for the JarvisOS installation directory!\n"
        "ENTER = Reboot computer"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "You cannot install JarvisOS within the installation source directory!\n"
        "ENTER = Reboot computer"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "The selected partition is not large enough to install JarvisOS.\n"
...
MUI_STRING enUSStrings[] =
{
    ...
    "You chose to install JarvisOS on a new or unformatted Partition."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "The system partition is not formatted yet."},
    {STRING_NONFORMATTEDOTHERPART,
    "The new partition is not formatted yet."},
    {STRING_INSTALLONPART,
    "Setup installs JarvisOS onto Partition"},
    {STRING_CHECKINGPART,

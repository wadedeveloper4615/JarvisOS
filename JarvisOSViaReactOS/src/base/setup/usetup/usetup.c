...
SelectFileSystemPage(PINPUT_RECORD Ir)
{
    ...
    if (FormatState == Start)
    {
        ...
        if (!SystemPartition)
        {
            ...
            //
            PopupError("The JarvisOS Setup could not find a supported system partition\n"
...
RunUSetup(VOID)
{
    ...
    while (Page != REBOOT_PAGE && Page != RECOVERY_PAGE)
    {
        ...
        // CONSOLE_SetUnderlinedTextXY(4, 3, " JarvisOS " KERNEL_VERSION_STR " Setup ");
        // CONSOLE_Flush();

...
#elif defined(SONAME_LIBMBEDTLS) && !defined(HAVE_COMMONCRYPTO_COMMONDIGEST_H) && !defined(__LCARSOS__)
WINE_DECLARE_DEBUG_CHANNEL(winediag);
...
#endif /* SONAME_LIBMBEDTLS && !HAVE_COMMONCRYPTO_COMMONDIGEST_H && !__LCARSOS__ */
